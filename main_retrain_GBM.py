...
#        if expts[res_dir]['pce_invalid_vars']: # if you exclude invalid PCE variables...
#            imputer = 'simple'
#            add_missing_flags = False
#        train_val_test(RESULT_DIR = '../Results/pcevars_' + res_dir + '_0506', alldata = alldata, 
...
#                      imputer = imputer, add_missing_flags = add_missing_flags)
    ...
    for res_dir in expts.keys():
        ...
        if expts[res_dir]['pce_invalid_vars']:
            imputer = 'simple'
            add_missing_flags = False
        train_val_test(RESULT_DIR = '../Results/allvars_' + res_dir + '_0506', alldata = alldata, 
                       to_exclude = expts[res_dir],
                       test_ind_col = test_ind_col, models = models, ascvd_est = ascvd_est, label = label,
                      imputer = imputer, add_missing_flags = add_missing_flags)
